      ...
      <div class="featureArtist">
        <?php
                ...
                foreach ($rows as $row)
                {
                    ...
                    echo "<img src='images/$row[artistPhoto]' class='artistPhotoRight'>";
      ...
      <?php
            ...
            foreach ($rows as $row)
            {
                if ($row[artistId] != $featuredArtistId) {
                    ...
                    echo "<a href='musicians.php?artistId=$row[artistId]'><img src='images/thumb$row[artistPhoto]' class='artistPhotoRight'></a><br>";
