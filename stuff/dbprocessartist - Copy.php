...
{
	$sql = "DELETE FROM artists WHERE id = '$_REQUEST[artistId]'";
	if ($dbh->exec($sql))
...
{
	$sql = "INSERT INTO artists (artistName, artistGenre, artistUrl, artistPhoto, artistText) VALUES ('$_REQUEST[artistName]', '$_REQUEST[artistGenre]', '$_REQUEST[artistUrl]', '$_REQUEST[artistPhoto]', '$_REQUEST[artistText]')";
	echo "<p>Query: " . $sql . "</p>\n<p><strong>"; 
	if ($dbh->exec($sql))
...
{
	$sql = "UPDATE artists SET artistName = '$_REQUEST[artistName]', artistGenre = '$_REQUEST[artistGenre]', artistUrl = '$_REQUEST[artistUrl]', artistPhoto = '$_REQUEST[artistPhoto]', artistText = '$_REQUEST[artistText]' WHERE artistId = '$_REQUEST[artistId]'";
	echo "<p>Query: " . $sql . "</p>\n<p><strong>"; 
	if ($dbh->exec($sql))
